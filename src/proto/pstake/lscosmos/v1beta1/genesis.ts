...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.hostChainRewardAddress = HostChainRewardAddress.decode(
            reader,
            reader.uint32()
          );
          break;
        case 7:
          message.iBCAmountTransientStore = IBCAmountTransientStore.decode(
            reader,
            reader.uint32()
          );
          break;
        case 8:
          message.unbondingEpochCValues.push(
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      moduleEnabled: isSet(object.moduleEnabled)
        ? Boolean(object.moduleEnabled)
        : false,
      ...
      unbondingEpochCValues: Array.isArray(object?.unbondingEpochCValues)
        ? object.unbondingEpochCValues.map((e: any) =>
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.moduleEnabled !== undefined &&
      (obj.moduleEnabled = message.moduleEnabled);
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.delegationState =
      object.delegationState !== undefined && object.delegationState !== null
        ...
        : undefined;
    message.hostChainRewardAddress =
      object.hostChainRewardAddress !== undefined &&
      object.hostChainRewardAddress !== null
        ? HostChainRewardAddress.fromPartial(object.hostChainRewardAddress)
        : undefined;
    message.iBCAmountTransientStore =
      object.iBCAmountTransientStore !== undefined &&
      object.iBCAmountTransientStore !== null
        ? IBCAmountTransientStore.fromPartial(object.iBCAmountTransientStore)
        : undefined;
    message.unbondingEpochCValues =
      object.unbondingEpochCValues?.map((e) =>
