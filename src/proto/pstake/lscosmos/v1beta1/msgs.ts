...
export const MsgRecreateICA = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRecreateICA>, I>>(
    object: I
  ): MsgRecreateICA {
    const message = createBaseMsgRecreateICA();
...
export const MsgRecreateICAResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRecreateICAResponse>, I>>(
    _: I
  ): MsgRecreateICAResponse {
    const message = createBaseMsgRecreateICAResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  RecreateICA(request: MsgRecreateICA): Promise<MsgRecreateICAResponse> {
    ...
    return promise.then((data) =>
      MsgRecreateICAResponse.decode(new _m0.Reader(data))
    );
  }
