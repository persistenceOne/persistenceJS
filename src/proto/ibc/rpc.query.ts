...
export const createRPCQueryClient = async ({
  ...
  ibc: {
    applications: {
      interchain_accounts: {
        controller: {
          v1: new (await import("./applications/interchain_accounts/controller/v1/query.rpc.query")).QueryClientImpl(rpc)
        },
        host: {
          v1: new (await import("./applications/interchain_accounts/host/v1/query.rpc.query")).QueryClientImpl(rpc)
        }
      },
      transfer: {
