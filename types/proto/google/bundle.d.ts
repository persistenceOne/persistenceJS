...
export declare namespace google {
  const api: {
    ...
    CustomHttpPattern: {
      encode(
        message: _220.CustomHttpPattern,
      ...
      fromPartial(object: { kind?: string; path?: string }): _220.CustomHttpPattern;
    };
  };
  const protobuf: {
    Timestamp: {
      ...
      fromPartial(object: { seconds?: any; nanos?: number }): _224.Timestamp;
    };
    Duration: {
      ...
      fromPartial(object: { seconds?: any; nanos?: number }): _223.Duration;
    };
    Any: {
      ...
      fromPartial(object: { typeUrl?: string; value?: Uint8Array }): _222.Any;
    };
  };
}
