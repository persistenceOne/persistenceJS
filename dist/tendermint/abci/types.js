...
var proof_js_1 = require("../crypto/proof.js");
...
exports.RequestBeginBlock = {
    encode: function (message, writer) {
        ...
        if (message.header !== undefined) {
            types_js_1.Header.encode(message.header, writer.uint32(18).fork()).ldelim();
        }
...
exports.ResponseQuery = {
    encode: function (message, writer) {
        ...
        if (message.proofOps !== undefined) {
            proof_js_1.ProofOps.encode(message.proofOps, writer.uint32(66).fork()).ldelim();
        }
        if (!message.height.isZero()) {
    ...
    fromJSON: function (object) {
        return {
            ...
            proofOps: isSet(object.proofOps)
                ? proof_js_1.ProofOps.fromJSON(object.proofOps)
                : undefined,
            height: isSet(object.height) ? long_1.default.fromValue(object.height) : long_1.default.ZERO,
    ...
    toJSON: function (message) {
        ...
        message.proofOps !== undefined &&
            (obj.proofOps = message.proofOps
                ? proof_js_1.ProofOps.toJSON(message.proofOps)
                : undefined);
        message.height !== undefined &&
            (obj.height = (message.height || long_1.default.ZERO).toString());
...
exports.ConsensusParams = {
    encode: function (message, writer) {
        ...
        if (message.evidence !== undefined) {
            params_js_1.EvidenceParams.encode(message.evidence, writer.uint32(18).fork()).ldelim();
        }
        if (message.validator !== undefined) {
            params_js_1.ValidatorParams.encode(message.validator, writer.uint32(26).fork()).ldelim();
        }
        if (message.version !== undefined) {
            params_js_1.VersionParams.encode(message.version, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.version = params_js_1.VersionParams.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            evidence: isSet(object.evidence)
                ? params_js_1.EvidenceParams.fromJSON(object.evidence)
                : undefined,
            validator: isSet(object.validator)
                ? params_js_1.ValidatorParams.fromJSON(object.validator)
                : undefined,
            version: isSet(object.version)
                ? params_js_1.VersionParams.fromJSON(object.version)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.evidence !== undefined &&
            (obj.evidence = message.evidence
                ? params_js_1.EvidenceParams.toJSON(message.evidence)
                : undefined);
        message.validator !== undefined &&
            (obj.validator = message.validator
                ? params_js_1.ValidatorParams.toJSON(message.validator)
                : undefined);
        message.version !== undefined &&
            (obj.version = message.version
                ? params_js_1.VersionParams.toJSON(message.version)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.evidence =
            object.evidence !== undefined && object.evidence !== null
                ? params_js_1.EvidenceParams.fromPartial(object.evidence)
                : undefined;
        message.validator =
            object.validator !== undefined && object.validator !== null
                ? params_js_1.ValidatorParams.fromPartial(object.validator)
                : undefined;
        message.version =
            object.version !== undefined && object.version !== null
                ? params_js_1.VersionParams.fromPartial(object.version)
                : undefined;
        return message;
    },
};
...
exports.Evidence = {
    encode: function (message, writer) {
        ...
        if (message.time !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.time), writer.uint32(34).fork()).ldelim();
        }
...
var ABCIApplicationClientImpl = /** @class */ (function () {
    ...
    ABCIApplicationClientImpl.prototype.Echo = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseEcho.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.Flush = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseFlush.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.Info = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseInfo.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.SetOption = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseSetOption.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.DeliverTx = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseDeliverTx.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.CheckTx = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseCheckTx.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.Query = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseQuery.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.Commit = function (request) {
        ...
        return promise.then(function (data) { return exports.ResponseCommit.decode(new _m0.Reader(data)); });
    };
    ABCIApplicationClientImpl.prototype.InitChain = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseInitChain.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.BeginBlock = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseBeginBlock.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.EndBlock = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseEndBlock.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.ListSnapshots = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseListSnapshots.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.OfferSnapshot = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseOfferSnapshot.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.LoadSnapshotChunk = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseLoadSnapshotChunk.decode(new _m0.Reader(data));
        });
    };
    ABCIApplicationClientImpl.prototype.ApplySnapshotChunk = function (request) {
        ...
        return promise.then(function (data) {
            return exports.ResponseApplySnapshotChunk.decode(new _m0.Reader(data));
        });
    };
