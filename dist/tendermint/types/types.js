...
var types_js_1 = require("../version/types.js");
...
exports.Part = {
    encode: function (message, writer) {
        ...
        if (message.proof !== undefined) {
            proof_js_1.Proof.encode(message.proof, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.proof = proof_js_1.Proof.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            bytes: isSet(object.bytes)
                ...
                : new Uint8Array(),
            proof: isSet(object.proof) ? proof_js_1.Proof.fromJSON(object.proof) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        ...
        message.proof !== undefined &&
            (obj.proof = message.proof ? proof_js_1.Proof.toJSON(message.proof) : undefined);
        return obj;
    },
    fromPartial: function (object) {
        var _a, _b;
        ...
        message.proof =
            object.proof !== undefined && object.proof !== null
                ? proof_js_1.Proof.fromPartial(object.proof)
                : undefined;
        return message;
    },
};
...
exports.Header = {
    encode: function (message, writer) {
        ...
        if (message.version !== undefined) {
            types_js_1.Consensus.encode(message.version, writer.uint32(10).fork()).ldelim();
        }
        if (message.chainId !== "") {
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.version = types_js_1.Consensus.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON: function (object) {
        return {
            version: isSet(object.version)
                ? types_js_1.Consensus.fromJSON(object.version)
                : undefined,
    ...
    toJSON: function (message) {
        ...
        message.version !== undefined &&
            (obj.version = message.version
                ? types_js_1.Consensus.toJSON(message.version)
                : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.version =
            object.version !== undefined && object.version !== null
                ? types_js_1.Consensus.fromPartial(object.version)
                : undefined;
...
exports.CommitSig = {
    encode: function (message, writer) {
        ...
        if (message.timestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.timestamp), writer.uint32(26).fork()).ldelim();
        }
        if (message.signature.length !== 0) {
