...
exports.QueryGrantsResponse = {
    ...
    fromJSON: function (object) {
        return {
            grants: Array.isArray(object === null || object === void 0 ? void 0 : object.grants)
                ? object.grants.map(function (e) { return authz_js_1.Grant.fromJSON(e); })
                : [],
            pagination: isSet(object.pagination)
    ...
    toJSON: function (message) {
        var obj = {};
        if (message.grants) {
            obj.grants = message.grants.map(function (e) { return (e ? authz_js_1.Grant.toJSON(e) : undefined); });
        }
        else {
            obj.grants = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryGrantsResponse();
        message.grants = ((_a = object.grants) === null || _a === void 0 ? void 0 : _a.map(function (e) { return authz_js_1.Grant.fromPartial(e); })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.Grants = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryGrantsResponse.decode(new _m0.Reader(data));
        });
    };
