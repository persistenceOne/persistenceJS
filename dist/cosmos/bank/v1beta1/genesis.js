...
exports.GenesisState = {
    encode: function (message, writer) {
        ...
        for (var _d = 0, _e = message.denomMetadata; _d < _e.length; _d++) {
            var v = _e[_d];
            bank_js_1.Metadata.encode(v, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.denomMetadata.push(bank_js_1.Metadata.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            denomMetadata: Array.isArray(object === null || object === void 0 ? void 0 : object.denomMetadata)
                ? object.denomMetadata.map(function (e) { return bank_js_1.Metadata.fromJSON(e); })
                : [],
        };
    },
    ...
    fromPartial: function (object) {
        ...
        message.supply = ((_b = object.supply) === null || _b === void 0 ? void 0 : _b.map(function (e) { return coin_js_1.Coin.fromPartial(e); })) || [];
        message.denomMetadata =
            ((_c = object.denomMetadata) === null || _c === void 0 ? void 0 : _c.map(function (e) { return bank_js_1.Metadata.fromPartial(e); })) || [];
        return message;
    },
};
