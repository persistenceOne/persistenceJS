    ...
    fromJSON: function (object) {
        return {
            allowance: isSet(object.allowance)
                ? feegrant_js_1.Grant.fromJSON(object.allowance)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.allowance !== undefined &&
            (obj.allowance = message.allowance
                ? feegrant_js_1.Grant.toJSON(message.allowance)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.allowance =
            object.allowance !== undefined && object.allowance !== null
                ? feegrant_js_1.Grant.fromPartial(object.allowance)
                : undefined;
        return message;
    },
};
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.Allowance = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryAllowanceResponse.decode(new _m0.Reader(data));
        });
    };
    QueryClientImpl.prototype.Allowances = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryAllowancesResponse.decode(new _m0.Reader(data));
        });
    };
