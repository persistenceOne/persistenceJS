...
exports.GenesisState = {
    encode: function (message, writer) {
        ...
        if (message.constantFee !== undefined) {
            coin_js_1.Coin.encode(message.constantFee, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 3:
                    message.constantFee = coin_js_1.Coin.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            constantFee: isSet(object.constantFee)
                ? coin_js_1.Coin.fromJSON(object.constantFee)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.constantFee !== undefined &&
            (obj.constantFee = message.constantFee
                ? coin_js_1.Coin.toJSON(message.constantFee)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.constantFee =
            object.constantFee !== undefined && object.constantFee !== null
                ? coin_js_1.Coin.fromPartial(object.constantFee)
                : undefined;
        return message;
    },
};
