...
exports.LegacyAminoPubKey = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.publicKeys.push(any_js_1.Any.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            publicKeys: Array.isArray(object === null || object === void 0 ? void 0 : object.publicKeys)
                ? object.publicKeys.map(function (e) { return any_js_1.Any.fromJSON(e); })
                : [],
        };
    },
    ...
    fromPartial: function (object) {
        ...
        message.publicKeys =
            ((_b = object.publicKeys) === null || _b === void 0 ? void 0 : _b.map(function (e) { return any_js_1.Any.fromPartial(e); })) || [];
        return message;
    },
};
