...
exports.Commission = {
    encode: function (message, writer) {
        ...
        if (message.updateTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.updateTime), writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.updateTime = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
...
exports.Validator = {
    encode: function (message, writer) {
        ...
        if (message.consensusPubkey !== undefined) {
            any_js_1.Any.encode(message.consensusPubkey, writer.uint32(18).fork()).ldelim();
        }
        ...
        if (message.unbondingTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.unbondingTime), writer.uint32(74).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.consensusPubkey = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                case 3:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    message.unbondingTime = fromTimestamp(timestamp_js_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 10:
    ...
    fromJSON: function (object) {
        return {
            ...
            consensusPubkey: isSet(object.consensusPubkey)
                ? any_js_1.Any.fromJSON(object.consensusPubkey)
                : undefined,
    ...
    toJSON: function (message) {
        ...
        message.consensusPubkey !== undefined &&
            (obj.consensusPubkey = message.consensusPubkey
                ? any_js_1.Any.toJSON(message.consensusPubkey)
                : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.consensusPubkey =
            object.consensusPubkey !== undefined && object.consensusPubkey !== null
                ? any_js_1.Any.fromPartial(object.consensusPubkey)
                : undefined;
...
exports.UnbondingDelegationEntry = {
    encode: function (message, writer) {
        ...
        if (message.completionTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.completionTime), writer.uint32(18).fork()).ldelim();
        }
...
exports.Params = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = _m0.Writer.create(); }
        if (message.unbondingTime !== undefined) {
            duration_js_1.Duration.encode(message.unbondingTime, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.unbondingTime = duration_js_1.Duration.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON: function (object) {
        return {
            unbondingTime: isSet(object.unbondingTime)
                ? duration_js_1.Duration.fromJSON(object.unbondingTime)
                : undefined,
    ...
    toJSON: function (message) {
        ...
        message.unbondingTime !== undefined &&
            (obj.unbondingTime = message.unbondingTime
                ? duration_js_1.Duration.toJSON(message.unbondingTime)
                : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.unbondingTime =
            object.unbondingTime !== undefined && object.unbondingTime !== null
                ? duration_js_1.Duration.fromPartial(object.unbondingTime)
                : undefined;
...
exports.DelegationResponse = {
    encode: function (message, writer) {
        ...
        if (message.balance !== undefined) {
            coin_js_1.Coin.encode(message.balance, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
