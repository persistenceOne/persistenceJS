...
exports.MsgCreateValidator = {
    encode: function (message, writer) {
        ...
        if (message.description !== undefined) {
            staking_js_1.Description.encode(message.description, writer.uint32(10).fork()).ldelim();
        }
        if (message.commission !== undefined) {
            staking_js_1.CommissionRates.encode(message.commission, writer.uint32(18).fork()).ldelim();
        }
        ...
        if (message.pubkey !== undefined) {
            any_js_1.Any.encode(message.pubkey, writer.uint32(50).fork()).ldelim();
        }
        if (message.value !== undefined) {
            coin_js_1.Coin.encode(message.value, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.description = staking_js_1.Description.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.commission = staking_js_1.CommissionRates.decode(reader, reader.uint32());
                    break;
                case 3:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.value = coin_js_1.Coin.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            description: isSet(object.description)
                ? staking_js_1.Description.fromJSON(object.description)
                : undefined,
            commission: isSet(object.commission)
                ? staking_js_1.CommissionRates.fromJSON(object.commission)
                : undefined,
            ...
            value: isSet(object.value) ? coin_js_1.Coin.fromJSON(object.value) : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.description !== undefined &&
            (obj.description = message.description
                ? staking_js_1.Description.toJSON(message.description)
                : undefined);
        message.commission !== undefined &&
            (obj.commission = message.commission
                ? staking_js_1.CommissionRates.toJSON(message.commission)
                : undefined);
        ...
        message.value !== undefined &&
            (obj.value = message.value ? coin_js_1.Coin.toJSON(message.value) : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.description =
            object.description !== undefined && object.description !== null
                ? staking_js_1.Description.fromPartial(object.description)
                : undefined;
        message.commission =
            object.commission !== undefined && object.commission !== null
                ? staking_js_1.CommissionRates.fromPartial(object.commission)
                : undefined;
        ...
        message.value =
            object.value !== undefined && object.value !== null
                ? coin_js_1.Coin.fromPartial(object.value)
                : undefined;
        return message;
    },
};
...
exports.MsgDelegate = {
    encode: function (message, writer) {
        ...
        if (message.amount !== undefined) {
            coin_js_1.Coin.encode(message.amount, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.MsgBeginRedelegate = {
    encode: function (message, writer) {
        ...
        if (message.amount !== undefined) {
            coin_js_1.Coin.encode(message.amount, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.MsgBeginRedelegateResponse = {
    encode: function (message, writer) {
        ...
        if (message.completionTime !== undefined) {
            timestamp_js_1.Timestamp.encode(toTimestamp(message.completionTime), writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.CreateValidator = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgCreateValidatorResponse.decode(new _m0.Reader(data));
        });
    };
    MsgClientImpl.prototype.EditValidator = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgEditValidatorResponse.decode(new _m0.Reader(data));
        });
    };
    MsgClientImpl.prototype.Delegate = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgDelegateResponse.decode(new _m0.Reader(data));
        });
    };
    MsgClientImpl.prototype.BeginRedelegate = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgBeginRedelegateResponse.decode(new _m0.Reader(data));
        });
    };
    MsgClientImpl.prototype.Undelegate = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgUndelegateResponse.decode(new _m0.Reader(data));
        });
    };
