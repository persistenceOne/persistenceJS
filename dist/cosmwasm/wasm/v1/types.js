...
exports.ContractInfo = {
    encode: function (message, writer) {
        ...
        if (message.extension !== undefined) {
            any_js_1.Any.encode(message.extension, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.extension = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            extension: isSet(object.extension)
                ? any_js_1.Any.fromJSON(object.extension)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.extension !== undefined &&
            (obj.extension = message.extension
                ? any_js_1.Any.toJSON(message.extension)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.extension =
            object.extension !== undefined && object.extension !== null
                ? any_js_1.Any.fromPartial(object.extension)
                : undefined;
        return message;
    },
};
