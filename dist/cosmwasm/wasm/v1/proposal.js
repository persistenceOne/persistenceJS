...
exports.StoreCodeProposal = {
    encode: function (message, writer) {
        ...
        if (message.instantiatePermission !== undefined) {
            types_js_1.AccessConfig.encode(message.instantiatePermission, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
...
exports.InstantiateContractProposal = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.funds; _i < _a.length; _i++) {
            var v = _a[_i];
            coin_js_1.Coin.encode(v, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
    ...
    fromPartial: function (object) {
        ...
        message.funds = ((_g = object.funds) === null || _g === void 0 ? void 0 : _g.map(function (e) { return coin_js_1.Coin.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.ExecuteContractProposal = {
    ...
    fromPartial: function (object) {
        ...
        message.funds = ((_f = object.funds) === null || _f === void 0 ? void 0 : _f.map(function (e) { return coin_js_1.Coin.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.PinCodesProposal = {
    ...
    fromPartial: function (object) {
        ...
        message.title = (_a = object.title) !== null && _a !== void 0 ? _a : "";
        message.description = (_b = object.description) !== null && _b !== void 0 ? _b : "";
        message.codeIds = ((_c = object.codeIds) === null || _c === void 0 ? void 0 : _c.map(function (e) { return long_1.default.fromValue(e); })) || [];
        return message;
    },
};
...
function createBaseAccessConfigUpdate() {
    return { codeId: long_1.default.UZERO, instantiatePermission: undefined };
}
exports.AccessConfigUpdate = {
    encode: function (message, writer) {
        ...
        if (message.instantiatePermission !== undefined) {
            types_js_1.AccessConfig.encode(message.instantiatePermission, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
...
exports.UpdateInstantiateConfigProposal = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.accessConfigUpdates; _i < _a.length; _i++) {
            var v = _a[_i];
    ...
    fromJSON: function (object) {
        return {
            ...
            accessConfigUpdates: Array.isArray(object === null || object === void 0 ? void 0 : object.accessConfigUpdates)
                ? object.accessConfigUpdates.map(function (e) {
                    return exports.AccessConfigUpdate.fromJSON(e);
                })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.accessConfigUpdates) {
            obj.accessConfigUpdates = message.accessConfigUpdates.map(function (e) {
                return e ? exports.AccessConfigUpdate.toJSON(e) : undefined;
            });
        }
        else {
    ...
    fromPartial: function (object) {
        ...
        message.accessConfigUpdates =
            ((_c = object.accessConfigUpdates) === null || _c === void 0 ? void 0 : _c.map(function (e) {
                return exports.AccessConfigUpdate.fromPartial(e);
            })) || [];
        return message;
    },
};
