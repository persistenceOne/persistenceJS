...
async function test(){
    ...
    var result = await identity.queryIdentity(config.nubID)

    if(result != undefined){
        console.log("result:" + result);
        var clsID = result.clasificationID + '|' + result.hashID
        identity.define(mnemonic, clsID, 25, "stake", 200000, "block")
            .then(txHash => {
...
// identity.nub(mnemonic, toAddress, "", "", "", "test3:test1,test3:test2", 25, "stake", 200000, "block")
//     .then(txHash => {
//         console.log("Tx successful. TxHash: ");
//         console.log(txHash);
//     })
...
// identity.define(mnemonic, toAddress, "", "", clsID, "test3:test1,test3:test2", 25, "stake", 200000, "block")
//     .then(txHash => {
//         console.log("Tx successful. TxHash: ");
//         console.log(txHash);
//     })
