...
var QueryDenomsMetadataResponse = {
  encode: function encode(message) {
    ...
    var _iterator3 = _createForOfIteratorHelper(message.metadatas),
        _step3;
