...
var ValidatorSlashEvent = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      validatorPeriod: (0, _helpers.isSet)(object.validatorPeriod) ? _helpers.Long.fromString(object.validatorPeriod) : _helpers.Long.UZERO,
...
var DelegatorStartingInfo = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      previousPeriod: (0, _helpers.isSet)(object.previousPeriod) ? _helpers.Long.fromString(object.previousPeriod) : _helpers.Long.UZERO,
