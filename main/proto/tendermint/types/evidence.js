...
var DuplicateVoteEvidence = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      validatorPower: (0, _helpers.isSet)(object.validatorPower) ? _helpers.Long.fromString(object.validatorPower) : _helpers.Long.ZERO,
...
var LightClientAttackEvidence = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      commonHeight: (0, _helpers.isSet)(object.commonHeight) ? _helpers.Long.fromString(object.commonHeight) : _helpers.Long.ZERO,
